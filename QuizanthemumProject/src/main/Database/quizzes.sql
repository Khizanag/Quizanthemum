...
-- default quizzes
insert into quizzes values (null, 'Geography quiz', 5, 'Check how you know capital cities', null, false, 'This quiz is easy one',
                            '1', sysdate(), 4);

insert into quizzes values (null, 'NBA quiz', 10, 'check how you recognize NBA players',
                            'https://theundefeated.com/wp-content/uploads/2017/06/nbalogo.jpg?w=1400',
                            false, 'this quiz is easy one',
                            '1', sysdate(), 2);

insert into quizzes values (null, 'Football quiz', 10, 'check how you football history',
